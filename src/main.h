...
#define VITASHELL_VERSION_MINOR 0x04

#define VITASHELL_VERSION ((VITASHELL_VERSION_MAJOR << 0x18) | (VITASHELL_VERSION_MINOR << 0x10))

// VitaTweakBox version major.minor
#define VITATWEAKBOX_VERSION_MAJOR 0x02
#define VITATWEAKBOX_VERSION_MINOR 0x10

#define VITATWEAKBOX_VERSION ((VITATWEAKBOX_VERSION_MAJOR << 0x18) | (VITATWEAKBOX_VERSION_MINOR << 0x10))

#define VITASHELL_LASTDIR "ux0:VitaTweakBox/internal/lastdir.txt"

// needs / at the end
#define VITASHELL_BOOKMARKS_PATH "ux0:VitaTweakBox/bookmarks/"
#define VITASHELL_RECENT_PATH "ux0:VitaTweakBox/recent/"
...
// Font BMK
#define FONT2_SIZE 1.4f
#define FONT2_Y_SPACE 30.0f
#define FONT3_Y_SPACE 28.0f
...
// BMK  
#define pgf2_draw_text(x, y, color, scale, text) \
	vita2d_pgf_draw_text(font, x, (y)+20, color, scale, text)

#define pgf2_draw_textf(x, y, color, scale, ...) \
...
enum DialogSteps {
  ...
  /////////////// BMK ////////////////
  DIALOG_STEP_DATABASE_UPDATE_QUESTION,
  DIALOG_STEP_DATABASE_LAYOUT_AFTERREBUILD,
  DIALOG_STEP_DATABASE_IMPORT_LAYOUT,
  DIALOG_STEP_DATABASE_SAVE_LAYOUT,
  DIALOG_STEP_DATABASE_CONFIRME_LAYOUT,
  DIALOG_STEP_DATABASE_UPDATE,
  DIALOG_STEP_DATABASE_REBUILD,
  DIALOG_STEP_DATABASE_REBOOT,
	
  DIALOG_STEP_DATABASE_AGREEMENT,
  DIALOG_STEP_VITAIDENT_AGREEMENT,
  DIALOG_STEP_FORECAST_AGREEMENT,
  DIALOG_STEP_VITABACKUP_AGREEMENT,
  DIALOG_STEP_VITABACKUP_MENU_AGREEMENT,
  DIALOG_STEP_VITARESTORE_AGREEMENT,
  DIALOG_STEP_BOOK_AGREEMENT,
  //DIALOG_STEP_VITAOPTIONS_AGREEMENT,
  DIALOG_STEP_BROWSER_AGREEMENT,
  DIALOG_STEP_FORECAST_ZIP,
  ////////////////////////////////////
  ...
  DIALOG_STEP_ENTER_ARCHIVE_BOOKS_PASSWORD,
