...
int mountGamecardUx0() {
  ...
  // Copy VitaShell
  copyPath("ux0:app/VITATWEAK", "ur0:temp/app", NULL);
  copyPath("ux0:appmeta/VITATWEAK", "ur0:temp/appmeta", NULL);
  copyPath("ux0:license/app/VITATWEAK", "ur0:temp/license", NULL);
  ...
  sceIoMkdir("ux0:app/VITATWEAK", 0006);
  sceIoMkdir("ux0:appmeta/VITATWEAK", 0006);
  sceIoMkdir("ux0:license/app/VITATWEAK", 0006);
  ...
  sceIoRemove("ux0:VitaTweakBox/internal/lastdir.txt");

  // Copy VitaShell
  copyPath("ur0:temp/app", "ux0:app/VITATWEAK", NULL);
  copyPath("ur0:temp/appmeta", "ux0:appmeta/VITATWEAK", NULL);
  copyPath("ur0:temp/license", "ux0:license/app/VITATWEAK", NULL);
...
int mountUsbUx0() {
  ...
  sceIoMkdir("uma0:app/VITATWEAK", 0006);
  sceIoMkdir("uma0:appmeta/VITATWEAK", 0006);
  sceIoMkdir("uma0:license/app/VITATWEAK", 0006);

  // Copy VitaShell
  copyPath("ux0:app/VITATWEAK", "uma0:app/VITATWEAK", NULL);
  copyPath("ux0:appmeta/VITATWEAK", "uma0:appmeta/VITATWEAK", NULL);
  copyPath("ux0:license/app/VITATWEAK", "uma0:license/app/VITATWEAK", NULL);
  ...
  // Remove lastdir.txt file
  sceIoRemove("uma0:VitaTweakBox/internal/lastdir.txt");
